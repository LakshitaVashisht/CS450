...
# myDataSet = read.csv("vowel.csv", head=TRUE, sep=",")
# myDataSet = read.csv("letters.csv", head=TRUE, sep=",")
# myDataSet = read.csv("abalone.csv", head=TRUE, sep=",")
...
model = svm(Species~., data = iris_train, kernel="radial", gamma = 0.001, cost = 10)
